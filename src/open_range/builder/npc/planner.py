...
_IT_SCHEDULE = [
    ...
    ScheduledAction(11, "access_share", "configs", "Update configuration files"),
    ScheduledAction(12, "send_email", "", "IT ticket follow-up"),
    ScheduledAction(13, "idle", "", "Lunch"),
    ScheduledAction(14, "browse", "/status", "Service health dashboard"),
    ScheduledAction(15, "query_db", "", "Afternoon health check"),
    ScheduledAction(16, "send_email", "", "End-of-day status report"),
]

_EXECUTIVE_SCHEDULE = [
    ScheduledAction(9, "access_share", "reports", "Review executive briefs"),
...
_GENERIC_SCHEDULE = [
    ScheduledAction(9, "query_db", "", "Morning data review"),
    ScheduledAction(10, "access_share", "shared", "File access"),
    ScheduledAction(11, "send_email", "", "Team communication"),
    ScheduledAction(12, "idle", "", "Lunch"),
    ScheduledAction(13, "browse", "/", "Afternoon tasks"),
    ScheduledAction(14, "send_email", "", "Status update"),
    ScheduledAction(15, "browse", "/", "Review dashboard"),
