...
class TestRuntimeNPCAgent:
    ...
    def test_idle_tasks_skipped_no_action_for_loner(self):
        ...
        from open_range.builder.npc.identity import (
            NPCBackstory,
            NPCPersonality,
            NPCProfile,
        )
    ...
    def test_email_task_includes_recipient_and_content(self):
        ...
        task = NPCTask(
            ...
            0,
            20,
            collaborators=(personas[1].id,),
            email_subject="Update",
            email_body="Hi, here's the update.",
        )
...
class TestDynamicReactions:
    ...
    def test_detection_alert_triggers_report(self):
        ...
        agent, outbox, inbox, clock = _make_agent(
            persona=riley,
            tasks=[NPCTask("Browse", "browse", "/", "", 100, 15)],
        )
        clock.advance(0.0)
    ...
    def test_non_security_service_degraded_contacts_helpdesk(self):
        ...
        clock.advance(0.0)
        inbox.push(
            _event("sd-1", event_type="ServiceDegraded", target_entity="svc-web")
        )
        agent._process_inbox()
    ...
    def test_incoming_mail_triggers_read_then_reply(self):
        ...
        mail_store.deliver(
            ...
            "bob.smith",
            "Q1 Report Review",
            "Hi Bob, please review the Q1 numbers.",
        )
...
class TestLLMIntegration:
    ...
    def test_llm_email_composition(self):
        ...
        task = NPCTask(
            "Client outreach", "send_email", "janet.liu", "", 0, 20, needs_llm=True
        )
